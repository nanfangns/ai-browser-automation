...
export const translations = {
    en: {
        ...
        "providerAnthropic": "Anthropic Messages API (Native)",
        "providerXai": "xAI Grok API",
        ...
        "customPromptDesc": "Add a global system prompt that will be included in every conversation. Use it to customize AI behavior, add context, or define specific rules.",
        "customPromptPlaceholder": "You are a helpful assistant that specializes in...",
        "promptPreset": "Preset",
        "promptPresetCustom": "Custom (Write your own below)",
    ...
    zh: {
        ...
        "providerAnthropic": "Anthropic Messages 原生 API",
        "providerXai": "xAI Grok API",
        ...
        "sourceCode": "源代码",
        "customPrompt": "自定义提示词",
        "customPromptDesc": "添加一个全局系统提示词，将包含在每次对话中。可用于自定义 AI 行为、添加上下文或定义特定规则。",
        "customPromptPlaceholder": "你是一个专门擅长...的助手",
        "promptPreset": "预设",
        "promptPresetCustom": "自定义 (在下方自行编写)",
        "system": "跟随系统",
        "light": "浅色",
        "dark": "深色",
